...
INSERT INTO `molajo_users` (`id`, `username`, `first_name`, `last_name`, `full_name`, `alias`, `content_text`, `email`, `password`, `block`, `activation_code`, `reset_password_code`, `login_attempts`, `last_activity_datetime`, `session_id`, `register_datetime`, `activation_datetime`, `last_visit_datetime`, `password_changed_datetime`, `customfields`, `parameters`, `metadata`) VALUES
